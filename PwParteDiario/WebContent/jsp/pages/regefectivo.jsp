...
<c:if test="${msg==1}">
	...
	<input type="hidden" name="idefectivo" value="${objefe.idefectivo}">
					...
					<div class="box-body">
						<div class="input-group">
							<span class="input-group-addon">Apellido Paterno</span> <input
								...
								placeholder="Apellido Paterno" required="required" value="${objefe.apepat}">
						</div>
						<br>
						<div class="input-group">
							<span class="input-group-addon">Apellido Materno</span> <input
								type="text" class="form-control" name="txtapemat"
								placeholder="Apellido Materno" required="required" value="${objefe.apemat}">
						</div>
						<br>
						<div class="input-group">
							<span class="input-group-addon">Nombres</span> <input type="text"
								class="form-control" name="txtnombres" placeholder="Nombres" required="required" value="${objefe.nombres}">
						</div>
						<br>
						<div class="input-group">
							<span class="input-group-addon">DNI</span> <input type="text"
								class="form-control" name="txtdni" placeholder="Nombres" required="required" value="${objefe.dni}">
						</div>
						<br>
				...
				<div class="box box-info">
					...
					<div class="input-group">
						<span class="input-group-addon">CIP</span> <input type="text"
							class="form-control" name="txtcip" placeholder="Cip" required="required" value="${objefe.cip}">
					</div>
					<br>
					<div class="input-group">
							...
							<tbody>
								<c:forEach items="${lista}" var="element" varStatus="count">
									<tr>
										...
										<td><a href="Sefectivo?action=getefe&id=${element.idefectivo}"> Seleccionar</a></td>
									</tr>
								</c:forEach>
							</tbody>
